...
const I18N = {
  ar: {
    home: "الرئيسية", search: "بحث", fav: "المفضلة", cart: "السلة", menu: "القائمة",
    addCart: "أضف", buy: "شراء من المتجر", builder: "منشئ التجميعات", compare: "مقارنة",
    checkout: "إرسال الطلب عبر واتساب", total: "المجموع", emptyCart: "السلة فارغة",
    admin: "لوحة التحكم", orders: "الطلبات", products: "المنتجات", stats: "الإحصائيات",
    new: "جديد", processing: "تجهيز", completed: "مكتمل", cancelled: "ملغي",
    allProducts: "كل المنتجات", offers: "عروض", language: "English"
  },
  en: {
    home: "Home", search: "Search", fav: "Wishlist", cart: "Cart", menu: "Menu",
    addCart: "Add", buy: "Buy from store", builder: "PC Builder", compare: "Compare",
    checkout: "Send order via WhatsApp", total: "Total", emptyCart: "Cart is empty",
    admin: "Admin", orders: "Orders", products: "Products", stats: "Stats",
    new: "New", processing: "Processing", completed: "Completed", cancelled: "Cancelled",
    allProducts: "All products", offers: "Offers", language: "العربية"
  }
};
let LANG = localStorage.getItem("tk_lang") || "ar";
